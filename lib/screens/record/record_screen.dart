...
import 'package:faspark/themes/theme.dart';
import 'package:faspark/screens/report/form_report.dart';
...
class _RecordScreenState extends State<RecordScreen> {
  ...
  void didChangeDependencies() {
    ...
    if (!_isLoaded) {
      Provider.of<RecordProvider>(context, listen: false).fetchRecord(widget.id);
      _isLoaded = true;
    }
  }
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        // Card untuk gambar dan fakultas
                        Card(
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(16),
                          ),
